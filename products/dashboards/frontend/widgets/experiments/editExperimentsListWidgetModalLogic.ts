...
export interface editExperimentsListWidgetModalLogicValues {
    activeFieldErrors: ExperimentsListWidgetFieldErrors
    defaultTitle: string
    ...
    validation:
        ...
        | {
              config: {
                  ...
                  orderBy: 'created_at' | 'name' | 'start_date'
                  orderDirection: 'ASC' | 'DESC'
                  status: 'all' | 'draft' | 'exposure_frozen' | 'paused' | 'running' | 'stopped'
              }
              success: true
          }
}
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface editExperimentsListWidgetModalLogicActions {
    clearFieldError: (field: keyof ExperimentsListWidgetFieldErrors) => {
        field: 'createdBy' | 'limit' | 'orderBy' | 'orderDirection' | 'status'
    }
    setFieldErrors: (fieldErrors: ExperimentsListWidgetFieldErrors) => {
        fieldErrors: Partial<Record<'createdBy' | 'limit' | 'orderBy' | 'orderDirection' | 'status', string>>
    }
    setLimit: (limit: number) => {
        limit: number
    }
    setOrderBy: (orderBy: ExperimentsListWidgetOrderBy) => {
        orderBy: ExperimentsListWidgetOrderBy
    }
    setOrderDirection: (orderDirection: ExperimentsListWidgetOrderDirection) => {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface editExperimentsListWidgetModalLogicMeta {
    __keaTypeGenInternalSelectorTypes: {
        ...
        activeFieldErrors: (
            validation:
                ...
                | {
                      fieldErrors: Partial<
                          Record<'createdBy' | 'limit' | 'orderBy' | 'orderDirection' | 'status', string>
                      >
                      success: false
                  },
            fieldErrors: Partial<Record<'createdBy' | 'limit' | 'orderBy' | 'orderDirection' | 'status', string>>
...
export type editExperimentsListWidgetModalLogicType = MakeLogicType<
    editExperimentsListWidgetModalLogicValues,
    editExperimentsListWidgetModalLogicActions,
    EditExperimentsListWidgetModalLogicProps,
    editExperimentsListWidgetModalLogicMeta
>
...
export const editExperimentsListWidgetModalLogic = kea<editExperimentsListWidgetModalLogicType>([
    ...
    selectors({
        ...
        validation: [
            ...
            (limit: number, orderBy: 'created_at' | 'name' | 'start_date', orderDirection: 'ASC' | 'DESC', config) => {
