...
export interface usageMetricsConfigLogicValues {
    ...
    usageMetrics: GroupUsageMetricApi[]
    usageMetricsLoading: boolean
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface usageMetricsConfigLogicActions {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface usageMetricsConfigLogicMeta {
    key: string
}

export type usageMetricsConfigLogicType = MakeLogicType<
    usageMetricsConfigLogicValues,
    usageMetricsConfigLogicActions,
    UsageMetricsConfigLogicProps,
    usageMetricsConfigLogicMeta
>
